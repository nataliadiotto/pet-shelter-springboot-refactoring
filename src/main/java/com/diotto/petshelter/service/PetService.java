...
public interface PetService {
    ...
    List<Pet> searchPets(String type, BiologicalSex biologicalSex, String name, String zipCode, String streetName, String city, Integer addressNumber, String state, Double age, Double weight, String breed) throws ResourceNotFound, BusinessRuleException;
